...
import { toMinutes } from '../../shared/utils/to-minutes';
    ...
    return (
        <View style={styles.Container}>
            ...
            {lastSeen > 59 ? (
                ...
                <Text style={[styles.title, fontStyles.bold]}>{lastSeen} seconds ago</Text>
            )}

            <Text style={[styles.currentTime, fontStyles.bold]}>
                Current Time: {moment.unix(currentTime).format('HH:mm:ss DD MMM YYYY')}
            </Text>
        </View>
    );
};
